...
float BME280::readFloatAltitudeMeters( void )
{
	...
	heightOutput = ((float)-45846.2)*(pow(((float)readFloatPressure()/(float)1013.25), 0.190263) - (float)1);
	return heightOutput;
...
float BME280::readFloatHumidity( void )
{
    ...
    // JB: removed this and did it adafruit's way to get a float instead of int
